	...
	<div class="container">
		...
		<div class="form-section">
			<form action="list" method="get">
				...
				</select> <label> <input type="checkbox" name="f3" value="t"
					<c:if test="${param.f3 == 't'}">checked</c:if> /> 在学中
				</label>

				<button type="submit">絞り込み</button>
				<span class="right-align"> <a
					href="${pageContext.request.contextPath}/student_create">新規登録</a>
				</span>
			</form>
		</div>
		...
		<div class="main">
			...
			<p>
				検索結果:
				<c:out value="${fn:length(studentList)}" />
				件
			</p>
						...
						<tbody>
							<c:forEach var="student" items="${studentList}">
								<tr>
									...
									<td><a
										href="${pageContext.request.contextPath}/student/update?no=${student.studentId}">
											変更 </a></td>
								</tr>
							</c:forEach>
						</tbody>
